...
namespace rendertoy
{
    ...
    static uint8_t const dot_font_library[97][5] = {
        ...
        {0xFF, 0x81, 0x81, 0x81, 0xFF}, // 80 UNKNOWN
    };

    const Image GenerateTextImage(const std::string &text, const glm::vec4 &color, const int font_size = 1)
    {
        const int char_width = 5;
        const int char_height = 8;

        int image_width = text.length() * (char_width + 1);
